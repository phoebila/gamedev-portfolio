export const projectDetails = {
  ...
  creativeCoding: {
     ...
     category: "Classwork",
     type: "Creative",
     description: "A collection of seven generative art and interactive coding experiments developed for CMPM 169 (Creative Coding) at UC Santa Cruz. Each experiment explores a different creative computing technique\u2014from procedural animation and particle systems to shader-based visuals\u2014following an \u201cImitate, Integrate, Innovate\u201d methodology. Built primarily with p5.js and JavaScript, with custom GLSL shaders for GPU-accelerated graphics.",
     skills: ["JavaScript", "p5.js", "GLSL", "HTML5", "CSS", "Creative Coding", "Generative Art"],
     embedUrl: process.env.PUBLIC_URL + "/creative-coding-embed.html",
     githubUrl: "https://github.com/phoebila/169-Page",
     projectUrl: "https://phoebila.github.io/169-Page/"
   },
  theTurning: {
   id: "theTurning",
   title: "The Turning",
